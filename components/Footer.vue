<template>
    <div class="flex flex-col justify-center items-center ">
        <div class="w-full flex justify-center items-center text-lg font-semibold mb-4">
            ...
            <p @click="logout" class="text-lg font-semibold before:content-['↗️'] cursor-pointer  whitespace-nowrap"
                v-if="authStore.authenticated">
        ...
        <p class="w-max flex font-light mb-6">🧑‍💻 Milan
                Theiß | Visit me on <a href="https://github.com/milantheiss"
                class="flex items-center hover:underline"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"
