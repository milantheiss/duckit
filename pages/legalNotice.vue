    ...
    <div class="bg-white px-4 py-4 rounded-lg drop-shadow-lg text-left mb-4 md:w-[920px] sm:w-[460px]">
        <div>
            ...
            <p>Milan Theiß <br>
                Burgweg 109<br>
                64807 Dieburg</p>
            <p>E-Mail: <a href='mailto:milan.theiss@gmx.net'>milan.theiss[at]gmx.net</a><br></p>
            <br>
            <p><strong class="text-lg font-bold">Haftungsausschluss: </strong><br>
                ...
                <br><strong>Google Analytics</strong><br><br>
