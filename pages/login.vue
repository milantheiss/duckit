        ...
        <div class="bg-white px-6 py-6 rounded-lg drop-shadow-md w-full">
            <form @submit.prevent="submit">
                <div class="flex items-center mb-6 w-full">
                    <!--Avatar Icon-->
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-8 mr-4 text-dark-grey" width="30" height="30">
                    ...
                    <TextInput type="text" name="username" v-model="form.username" placeholder="Username" class="text-lg" ref="usernameInput"></TextInput>
                </div>
                <div class="flex items-center w-full">
                    ...
                    <TextInput type="password" name="password" v-model="form.password" placeholder="Passwort" class="text-lg" ref="passwordInput"> 
                    </TextInput>
                </div>
