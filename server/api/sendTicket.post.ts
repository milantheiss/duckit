...
async function generatePDF(ticketCode: string) {
	...
	pdf.setFont("Ubuntu-Regular").setFontSize(18).addImage(calIcon, "PNG", 25.169, 32, 9, 9).text("Wann? Am 07.07.2023", 39.169, 39).text("Einlass ab 22:30 Uhr", 60.169, 47);
	...
	.text("In d. Altstadt 5, Dieburg", 53.640, 63);
